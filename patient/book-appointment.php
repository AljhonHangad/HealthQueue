...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($values['appointment_time'] === '') $errors[] = 'Please choose an appointment time.';
    ...
    if (!$errors && $pdo) {
        try {
            ...
            $stmt->execute([$user['UserID'], (int) $values['clinic_id'], $values['physician_id'] !== '' ? (int) $values['physician_id'] : null, $values['appointment_date'], $values['appointment_time'], $values['concern'] ?: null]);
            ...
            if ($isAjax) {
                ...
                echo json_encode([
                    ...
                    'appointment_time' => date('g:i A', strtotime($values['appointment_time'])),
